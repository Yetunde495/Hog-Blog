(function ($) {
  ...
  //category nav toggle
  $(document).ready(function () {
    $("#toggleCategoryNav").click(function () {
      $(".category-navbar-nav").toggleClass("show");
    });
  });
...
function submitForm(event) {
  ...
  if (form.checkValidity()) {
    ...
    inputs.forEach(function (input) {
      ...
      var errorMessage = input.parentNode.lastElementChild;

      if (errorMessage && errorMessage.classList.contains("error-message")) {
        if (fieldName === "password") {
          errorMessage.textContent = "password must contain letters, numbers and 8 characters long";
        } else {
